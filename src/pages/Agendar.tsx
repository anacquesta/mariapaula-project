  ...
  return (
    <main className="bg-background text-foreground min-h-screen overflow-x-hidden">
      ...
      <section className="pb-24">
        <div className="container grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16">
          {/* Calendar */}
          <div className="col-span-1 md:col-span-7 min-w-0">
          ...
          {/* Form */}
          <form onSubmit={handleSubmit} className="col-span-1 md:col-span-5 space-y-6 min-w-0" noValidate>
